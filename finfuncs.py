...
def update_sp500_data():
    ...
    constituents_df = pd.read_csv('/home/xryrapier/code/Xryrapier/000-Project_X/Data/constituents_csv.csv')
...
def get_sp500_data ():
    with open('/home/xryrapier/code/Xryrapier/000-Project_X/Notebooks/sp500_all.pkl'
, 'rb') as f:
